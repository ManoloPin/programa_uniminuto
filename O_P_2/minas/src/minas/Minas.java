...
public class Minas extends JFrame {
    ...
    private void jbInit() throws Exception {
        ...
        jPanel1.setBackground(new Color(2, 125, 27));
...
//        —- Oculta los botones del contorno que no participaran en el juego.
    ...
    public void colocarBomba(int numeroBombas) {
        ...
        do {
            ...
            if (z != 0 && i != 0 && z != alto - 1 && i != ancho - 1) {
                ...
                Botones[(int) i][(int) z].setForeground(Color.RED);
                // Botones[(int) i][(int) z].setText("*") ;
                elArray[(int) i][(int) z] = "*";
    ...
    //—- Asigna un número a cada boton dependiendo de los * que tenga al lado.
